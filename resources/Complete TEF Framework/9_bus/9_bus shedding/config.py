...
RAW_FILE = os.path.join(WORK_DIR, "IEEE9busshed.raw")
DYR_FILE = os.path.join(WORK_DIR, "ieee9busshed.dyr")
OUT_FILE = os.path.join(RESULT_DIR, "9bussheding.out")
...
T_CLEAR = 0.22
T_END = T_FAULT_START + T_CLEAR+10
# ==============================================================================
