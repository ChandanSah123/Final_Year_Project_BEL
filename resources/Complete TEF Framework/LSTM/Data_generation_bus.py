...
for FAULT_DURATION in durations:
    ...
    for f_bus in fault_buses:
        ...
        time_data = np.array(chandata['time'])
        ang_g1 = np.array(chandata[1])
        ang_g2 = np.array(chandata[2])
        ang_g3 = np.array(chandata[3])
        ang_g4 = np.array(chandata[4])
        ang_g5 = np.array(chandata[5])
        ang_g6 = np.array(chandata[6])
        ang_g7 = np.array(chandata[7])
        ang_g8 = np.array(chandata[8])
        ang_g9 = np.array(chandata[9])
        ang_g10 = np.array(chandata[10])
        spd_g1 = np.array(chandata[11])
        spd_g2 = np.array(chandata[12])
        spd_g3 = np.array(chandata[13])
        spd_g4 = np.array(chandata[14])
        spd_g5 = np.array(chandata[15])
        spd_g6 = np.array(chandata[16])
        spd_g7 = np.array(chandata[17])
        spd_g8 = np.array(chandata[18])
        spd_g9 = np.array(chandata[19])
        spd_g10 = np.array(chandata[20])
        pe_g1 = np.array(chandata[21])
        pe_g2 = np.array(chandata[22])
        pe_g3 = np.array(chandata[23])
        pe_g4 = np.array(chandata[24])
        pe_g5 = np.array(chandata[25])
        pe_g6 = np.array(chandata[26])
        pe_g7 = np.array(chandata[27])
        pe_g8 = np.array(chandata[28])
        pe_g9 = np.array(chandata[29])
        pe_g10 = np.array(chandata[30])
        vt_g1 = np.array(chandata[31])
        vt_g2 = np.array(chandata[32])
        vt_g3 = np.array(chandata[33])
        vt_g4 = np.array(chandata[34])
        vt_g5 = np.array(chandata[35])
        vt_g6 = np.array(chandata[36])
        vt_g7 = np.array(chandata[37])
        vt_g8 = np.array(chandata[38])
        vt_g9 = np.array(chandata[39])
        vt_g10 = np.array(chandata[40])
        
        # Filter data to only include time points AFTER fault clearing
        fault_clear_time = FAULT_TIME + FAULT_DURATION
        mask = time_data >= fault_clear_time
