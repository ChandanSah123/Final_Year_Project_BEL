...
Vcr_linear = Calculate_PE_single_point(theta_cuep_mod, ths, Pi, C, D, g);
D_zero = zeros(size(D));
Vcr_zero = Calculate_PE_single_point(theta_cuep_mod, ths, Pi, C, D_zero, g);
% Use the Average
Vcr_candidate = (Vcr_linear + Vcr_zero) / 2;
