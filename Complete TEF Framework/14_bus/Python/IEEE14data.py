...
if data_columns:
    ...
    print("Columns 1-5:   Rotor Angle (delta)")
    print("Columns 6-10:  Speed (omega)")
    print("Columns 11-15: Mechanical Power (Pm)")
    print("Columns 16-20: Electrical Power (Pe)")
    print("Columns 21-25: Reactive Power (Q)")
    print("Column  26:    Simulation Time (t)")
else:
